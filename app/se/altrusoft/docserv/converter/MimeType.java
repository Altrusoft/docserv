...
public enum MimeType {
	@SuppressWarnings("serial") PDF("application/pdf", "writer_pdf_Export", new HashMap<String, Object>() {
		{
			// Generate PDF/A
			put("SelectPdfVersion", 1);
		}
	}), ODS("application/vnd.oasis.opendocument.spreadsheet"), ODT("application/vnd.oasis.opendocument.text"), XLS(
	...
	MimeType(String value, String convertFilterName, Map<String, Object> filterParameters) {
		this.value = value;
		this.convertFilterName = convertFilterName;
