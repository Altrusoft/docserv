...
public class ODTProcessorTest {
	...
	public void test_markup() {
		try {
			ODTProcessor.transformODT("test/se/altrusoft/docserv/odsprocessor/test_markup_input.ods",
	...
	public void simpleODSProcessorShouldWork() {
		try {
			ODTProcessor.transformODT("test/se/altrusoft/docserv/odsprocessor/test_floatification_input.ods",
